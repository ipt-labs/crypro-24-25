...
if __name__ == "__main__":
    ...
    rd_bigrams_spaces_overlap = calc_redundancy(h2_spaces_overlap, 32 ** 2)
    ...
    rd_bigrams_spaces_no_overlap = calc_redundancy(h2_spaces_no_overlap, 32 ** 2)
    ...
    rd_bigrams_no_spaces_overlap = calc_redundancy(h2_no_spaces_overlap, 32 ** 2)
    ...
    rd_bigrams_no_spaces_no_overlap = calc_redundancy(h2_no_spaces_no_overlap, 32 ** 2)
